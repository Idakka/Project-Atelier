...
const RatingsAndReviews = function({ top, onChangeFileHandler, onClickUploadHandler, productId, currentProduct, reviews, reviewsMeta, selectedImageFiles, fileLoaded }) {
